...
#SBATCH --gres=gpu:0
#SBATCH --output=/home/febrinam-pg/finalcricketnrp/logs/msa/af3_msa_rho_%A_%a.out
#SBATCH --error=/home/febrinam-pg/finalcricketnrp/logs/msa/af3_msa_rho_%A_%a.err
#SBATCH --array=1-66
...
INPUT_DIR="/home/febrinam-pg/finalcricketnrp/json/receptor/rhodopsin"
MSA_OUT_BASE="/home/febrinam-pg/finalcricketnrp/af3/msa/receptor/rhodopsin"

PEPTIDE_LIST="${INPUT_DIR}/rhodopsinreceptor_list.txt"
