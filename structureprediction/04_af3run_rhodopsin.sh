...
#SBATCH --gres=gpu:1
#SBATCH --output=/home/febrinam-pg/finalcricketnrp/logs/predict/af3pred_rhod_%A_%a.out
#SBATCH --error=/home/febrinam-pg/finalcricketnrp/logs/predict/af3pred_rhod_%A_%a.err
#SBATCH --array=1-119
