#!/bin/bash
#SBATCH --job-name=af3_msa_peptide
#SBATCH -p l40s
#SBATCH -A l40s
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --gres=gpu:0
#SBATCH --output=/home/febrinam-pg/finalcricketnrp/logs/msa/af3_msa_peptide_%A_%a.out
#SBATCH --error=/home/febrinam-pg/finalcricketnrp/logs/msa/af3_msa_peptide_%A_%a.err
#SBATCH --array=1-119
...
INPUT_DIR="/home/febrinam-pg/finalcricketnrp/json/peptide_af3"
MSA_OUT_BASE="/home/febrinam-pg/finalcricketnrp/af3/msa/peptide_af3"

PEPTIDE_LIST="${INPUT_DIR}/peptide_list.txt"
